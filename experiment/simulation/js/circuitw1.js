...
/*validation of vcc and gnd */
    ...
    if(image3.getAttribute('src')=="images/on.png" && image9.getAttribute('src')=="images/on.png"){
      ...
      else  if(image9.getAttribute('src')=="images/off.png" && image3.getAttribute('src')=="images/on.png" ){
            document.getElementById("msg").innerHTML = 'VCC and GND are properly connected';
            document.getElementById("showalt").style.visibility = 'visible';
			document.getElementById("msg").style.color="green";
        }
       
        else if(image3.getAttribute('src')=="images/on.png" ){
            document.getElementById("msg").innerHTML = 'VCC and GND are properly connected';
            document.getElementById("showalt").style.visibility = 'visible';
			document.getElementById("msg").style.color="green";
        }
		else if(image3.getAttribute('src')=="images/off.png" ){
            document.getElementById("msg").innerHTML = 'Please connect VCC  properly';
            document.getElementById("showalt").style.visibility = 'visible';
			document.getElementById("msg").style.color="red";
        }
        else if(image9.getAttribute('src')=="images/on.png" ){
            document.getElementById("msg").innerHTML = 'Please connect GND properly (Make GND to LOW) ';
        document.getElementById("showalt").style.visibility = 'visible';
		document.getElementById("msg").style.color="red";
  ...
  if(image3.getAttribute('src')=="images/on.png"
	...
	if(image6.getAttribute('src')=="images/off.png" && image5.getAttribute('src')=="images/off.png" && image1.getAttribute('src')=="images/off.png" && image11.getAttribute('src')=="images/off.png" )
	{
		document.getElementById("binaryinpA").value = '0000';//0
		binarytodecimal_A();
		decA_add_decB();
		}
		if( image6.getAttribute('src')=="images/off.png" && image5.getAttribute('src')=="images/off.png" && image1.getAttribute('src')=="images/off.png" && image11.getAttribute('src')=="images/on.png" )
	{
		document.getElementById("binaryinpA").value = '0001';//1
		binarytodecimal_A();
		decA_add_decB();
		}
		if( image6.getAttribute('src')=="images/off.png" && image5.getAttribute('src')=="images/off.png" && image1.getAttribute('src')=="images/on.png" && image11.getAttribute('src')=="images/off.png" )
	{
		document.getElementById("binaryinpA").value = '0010';//2
		binarytodecimal_A();
		decA_add_decB();
		}
		if( image6.getAttribute('src')=="images/off.png" && image5.getAttribute('src')=="images/off.png" && image1.getAttribute('src')=="images/on.png" && image11.getAttribute('src')=="images/on.png" )
	{
		document.getElementById("binaryinpA").value = '0011';//3
		binarytodecimal_A();
		decA_add_decB();
		}
		if( image6.getAttribute('src')=="images/off.png" && image5.getAttribute('src')=="images/on.png" && image1.getAttribute('src')=="images/off.png" && image11.getAttribute('src')=="images/off.png" )
	{
		document.getElementById("binaryinpA").value = '0100';//4
		binarytodecimal_A();
		decA_add_decB();
		}
		if( image6.getAttribute('src')=="images/off.png" && image5.getAttribute('src')=="images/on.png" && image1.getAttribute('src')=="images/off.png" && image11.getAttribute('src')=="images/on.png" )
	{
		document.getElementById("binaryinpA").value = '0101';//5
		binarytodecimal_A();
		decA_add_decB();
		}
		if( image6.getAttribute('src')=="images/off.png" && image5.getAttribute('src')=="images/on.png" && image1.getAttribute('src')=="images/on.png" && image11.getAttribute('src')=="images/off.png" )
	{
		document.getElementById("binaryinpA").value = '0110';//6
		binarytodecimal_A();
		decA_add_decB();
		}
		if( image6.getAttribute('src')=="images/off.png" && image5.getAttribute('src')=="images/on.png" && image1.getAttribute('src')=="images/on.png" && image11.getAttribute('src')=="images/on.png" )
	{
		document.getElementById("binaryinpA").value = '0111';//7
		binarytodecimal_A();
		decA_add_decB();
		}
		if( image6.getAttribute('src')=="images/on.png" && image5.getAttribute('src')=="images/off.png" && image1.getAttribute('src')=="images/off.png" && image11.getAttribute('src')=="images/off.png" )
	{
		document.getElementById("binaryinpA").value = '1000';//8
		binarytodecimal_A();
		decA_add_decB();
		}
		if( image6.getAttribute('src')=="images/on.png" && image5.getAttribute('src')=="images/off.png" && image1.getAttribute('src')=="images/off.png" && image11.getAttribute('src')=="images/on.png" )
	{
		document.getElementById("binaryinpA").value = '1001';//9
		binarytodecimal_A();
		decA_add_decB();
		}
		if( image6.getAttribute('src')=="images/on.png" && image5.getAttribute('src')=="images/off.png" && image1.getAttribute('src')=="images/on.png" && image11.getAttribute('src')=="images/off.png" )
	{
		document.getElementById("binaryinpA").value = '1010';//10
		binarytodecimal_A();
		decA_add_decB();
		}
		if( image6.getAttribute('src')=="images/on.png" && image5.getAttribute('src')=="images/off.png" && image1.getAttribute('src')=="images/on.png" && image11.getAttribute('src')=="images/on.png" )
	{
		document.getElementById("binaryinpA").value = '1011';//11
		binarytodecimal_A();
		decA_add_decB();
		}
		if( image6.getAttribute('src')=="images/on.png" && image5.getAttribute('src')=="images/on.png" && image1.getAttribute('src')=="images/off.png" && image11.getAttribute('src')=="images/off.png" )
	{
		document.getElementById("binaryinpA").value = '1100';//12
		binarytodecimal_A();
		decA_add_decB();
		}
		if( image6.getAttribute('src')=="images/on.png" && image5.getAttribute('src')=="images/on.png" && image1.getAttribute('src')=="images/off.png" && image11.getAttribute('src')=="images/on.png" )
	{
		document.getElementById("binaryinpA").value = '1101';//13
		binarytodecimal_A();
		decA_add_decB();
		}
		if( image6.getAttribute('src')=="images/on.png" && image5.getAttribute('src')=="images/on.png" && image1.getAttribute('src')=="images/on.png" && image11.getAttribute('src')=="images/off.png" )
	{
		document.getElementById("binaryinpA").value = '1110';//14
		binarytodecimal_A();
		decA_add_decB();
		}
		if( image6.getAttribute('src')=="images/on.png" && image5.getAttribute('src')=="images/on.png" && image1.getAttribute('src')=="images/on.png" && image11.getAttribute('src')=="images/on.png" )
	{
	...
	if( image7.getAttribute('src')=="images/off.png" && image4.getAttribute('src')=="images/off.png" && image2.getAttribute('src')=="images/off.png" && image10.getAttribute('src')=="images/off.png" )
	{
		document.getElementById("binaryinpB").value = '0000';//0
		binarytodecimal_B();
		decA_add_decB();
		}
		if( image7.getAttribute('src')=="images/off.png" && image4.getAttribute('src')=="images/off.png" && image2.getAttribute('src')=="images/off.png" && image10.getAttribute('src')=="images/on.png" )
	{
		document.getElementById("binaryinpB").value = '0001';//1
		binarytodecimal_B();
		decA_add_decB();
		}
		if( image7.getAttribute('src')=="images/off.png" && image4.getAttribute('src')=="images/off.png" && image2.getAttribute('src')=="images/on.png" && image10.getAttribute('src')=="images/off.png" )
	{
		document.getElementById("binaryinpB").value = '0010';//2
		binarytodecimal_B();
		decA_add_decB();
		}
		if( image7.getAttribute('src')=="images/off.png" && image4.getAttribute('src')=="images/off.png" && image2.getAttribute('src')=="images/on.png" && image10.getAttribute('src')=="images/on.png" )
	{
		document.getElementById("binaryinpB").value = '0011';//3
		binarytodecimal_B();
		decA_add_decB();
		}
		if( image7.getAttribute('src')=="images/off.png" && image4.getAttribute('src')=="images/on.png" && image2.getAttribute('src')=="images/off.png" && image10.getAttribute('src')=="images/off.png" )
	{
		document.getElementById("binaryinpB").value = '0100';//4
		binarytodecimal_B();
		decA_add_decB();
		}
		if(image7.getAttribute('src')=="images/off.png" && image4.getAttribute('src')=="images/on.png" && image2.getAttribute('src')=="images/off.png" && image10.getAttribute('src')=="images/on.png" )
	{
		document.getElementById("binaryinpB").value = '0101';//5
		binarytodecimal_B();
		decA_add_decB();
		}
		if( image7.getAttribute('src')=="images/off.png" && image4.getAttribute('src')=="images/on.png" && image2.getAttribute('src')=="images/on.png" && image10.getAttribute('src')=="images/off.png" )
	{
		document.getElementById("binaryinpB").value = '0110';//6
		binarytodecimal_B();
		decA_add_decB();
		}
		if( image7.getAttribute('src')=="images/off.png" && image4.getAttribute('src')=="images/on.png" && image2.getAttribute('src')=="images/on.png" && image10.getAttribute('src')=="images/on.png" )
	{
		document.getElementById("binaryinpB").value = '0111';//7
		binarytodecimal_B();
		decA_add_decB();
		}
		if( image7.getAttribute('src')=="images/on.png" && image4.getAttribute('src')=="images/off.png" && image2.getAttribute('src')=="images/off.png" && image10.getAttribute('src')=="images/off.png" )
	{
		document.getElementById("binaryinpB").value = '1000';//8
		binarytodecimal_B();
		decA_add_decB();
		}
		if( image7.getAttribute('src')=="images/on.png" && image4.getAttribute('src')=="images/off.png" && image2.getAttribute('src')=="images/off.png" && image10.getAttribute('src')=="images/on.png" )
	{
		document.getElementById("binaryinpB").value = '1001';//9
		binarytodecimal_B();
		decA_add_decB();
		}
		if( image7.getAttribute('src')=="images/on.png" && image4.getAttribute('src')=="images/off.png" && image2.getAttribute('src')=="images/on.png" && image10.getAttribute('src')=="images/off.png" )
	{
		document.getElementById("binaryinpB").value = '1010';//10
		binarytodecimal_B();
		decA_add_decB();
		}
		if( image7.getAttribute('src')=="images/on.png" && image4.getAttribute('src')=="images/off.png" && image2.getAttribute('src')=="images/on.png" && image10.getAttribute('src')=="images/on.png" )
	{
		document.getElementById("binaryinpB").value = '1011';//11
		binarytodecimal_B();
		decA_add_decB();
		}
		if( image7.getAttribute('src')=="images/on.png" && image4.getAttribute('src')=="images/on.png" && image2.getAttribute('src')=="images/off.png" && image10.getAttribute('src')=="images/off.png")
	{
		document.getElementById("binaryinpB").value = '1100';//12
		binarytodecimal_B();
		decA_add_decB();
		}
		if( image7.getAttribute('src')=="images/on.png" && image4.getAttribute('src')=="images/on.png" && image2.getAttribute('src')=="images/off.png" && image10.getAttribute('src')=="images/on.png" )
	{
		document.getElementById("binaryinpB").value = '1101';//13
		binarytodecimal_B();
		decA_add_decB();
		}
		if( image7.getAttribute('src')=="images/on.png" && image4.getAttribute('src')=="images/on.png" && image2.getAttribute('src')=="images/on.png" && image10.getAttribute('src')=="images/off.png" )
	{
		document.getElementById("binaryinpB").value = '1110';//14
		binarytodecimal_B();
		decA_add_decB();
		}
		if( image7.getAttribute('src')=="images/on.png" && image4.getAttribute('src')=="images/on.png" && image2.getAttribute('src')=="images/on.png" && image10.getAttribute('src')=="images/on.png" )
	{
